 ...
 * <p>
 * see the originol demo video by Viktor Bohush at:
 * https://www.youtube.com/watch?v=ZZuD6iUe3Pc
 * <p>
 * Source Code original author is Viktor Bohush as seen at:
 * https://github.com/vbohush/SortingAlgorithmAnimations
 */
public class Main extends JApplet {

	private static final long serialVersionUID = 1L;
	private sorting.SortPanel[] sortPanels = new sorting.SortPanel[9];
	...
	public Main() {
		...
		sortPanels[0] = new sorting.SelectionSortPanel(" Selection Sort ", sleepTime, width, height);
		sortPanels[1] = new sorting.ShellSortPanel(" Shell Sort ", sleepTime, width, height);
		sortPanels[2] = new InsertionSortPanel(" Insertion Sort ", sleepTime, width, height);
		sortPanels[3] = new sorting.MergeSortPanel(" Merge Sort ", sleepTime, width, height);
		sortPanels[4] = new sorting.QuickSortPanel(" Quick Sort ", sleepTime, width, height);
