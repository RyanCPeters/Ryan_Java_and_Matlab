...
public class SnowFlake extends JApplet {
	...
	public void paint(Graphics g) {
		Point pointOne = new Point(120, 320);//bot left
		Point pointTwo = new Point(440, 320); //botRight   // reusing Points from example program * 2;
		Point pointThree = new Point(280, 40);// topCenter
